...
def send_email_alert():
    ...
    s.starttls()
    # Authentication
    s.login("ayanavcoe97@gmail.com", "yamp brbr lrqj atsz")
    # message to be sent
    message = "Crime detected"
    # sending the mail
    s.sendmail("ayanpathan443@gmail.com", "ayanpathan443@gmail.com", message)
...
def make_landmark_timestep(results):
    ...
    return c_lm if len(c_lm) == 132 else []

alert_sent = False  # To prevent sending multiple emails for same event
